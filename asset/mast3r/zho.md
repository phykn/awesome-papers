...
#### 4.4 对比：其他方法 vs 本文 (Evidence-Based)
...
- **[MUSt3R: Multi-view Network for Stereo 3D Reconstruction](https://arxiv.org/abs/2503.01661)**: 将该框架扩展到多视角同时处理，并引入了多层存储机制。
- **[MASt3R-SfM: a Fully-Integrated Solution for Unconstrained Structure-from-Motion](https://arxiv.org/abs/2409.18844)**: 利用 MASt3R 特征进行大规模、无约束重建的完整 SfM 流水线。
- **[TRELLIS: Structured 3D Latents for Scalable and Versatile 3D Generation](https://arxiv.org/abs/2412.01506)**: 探索如何将类似的视觉基础模型特征用于高质量3D资产生成。
