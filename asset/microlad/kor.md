# MicroLad: Latent Diffusion 기반 2D-to-3D 미세구조 재구성 및 역설계
...
- **공식**: $\mathcal{L}_{\text{SDS}} = \kappa(t) \|\epsilon - \epsilon_\theta(z_{\text{slice},t}, t)\|^2$, 단 $\kappa(t) = \frac{1 - \bar{\alpha}_t}{\bar{\alpha}_t}$
...
#### 4.4 비교: 다른 기술 vs 이 논문 (Evidence-Based)
...
- [SliceGAN: GAN 기반 차원 확장을 통한 2D 슬라이스로부터의 3D 구조 생성](https://arxiv.org/abs/1903.12564) - 2D-to-3D 미세구조 생성의 GAN 기반 베이스라인.
- [Latent Diffusion Models (Stable Diffusion)](https://arxiv.org/abs/2112.10752) - MicroLad가 기반한 핵심 잠재 확산 아키텍처.
- [Differentiable Physics Simulation for Materials Design](https://doi.org/10.1016/j.cma.2023.116000) - 물리 정보 기반 접근법으로 재료 구조의 기울기 기반 최적화를 가능하게 함.
