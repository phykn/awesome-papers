...
- [RawNeRF: Preparing for Real HDR View Synthesis with Neural Radiance Fields](https://cvgl.stanford.edu/projects/rawnerf/) - 直接学习摄像机的 RAW 数据，实现了高动态范围 (HDR) 视图合成和去噪。
