...
A direct follow-up that moves the process to latent space for faster and more controlled 3D generation.<br>
...
Explores scaling these generative methods to massive volumes and complex boundary conditions.<br>
...
Focuses on inpainting-based diffusion to reconstruct large-scale polycrystalline materials.<br>
