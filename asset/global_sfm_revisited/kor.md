...
일차 최적화(First-order optimization)를 사용하여 GLOMAP보다 최대 10배 더 빠른 속도를 구현한 2025년 후속 연구입니다.<br>
[2] [Gravity-Aligned Rotation Averaging with Circular Regression (2024)](https://arxiv.org/abs/2410.12763)<br>
GLOMAP 저자들이 참여한 2024년 연구로, 중력 방향 정렬을 통해 회전 평균화의 정확도를 더욱 높였습니다.<br>
[3] [MP-SfM: Monocular Surface Priors for Robust Structure-From-Motion (2025)](https://arxiv.org/abs/2504.20040)<br>
단안 표면 사전 정보(Monocular surface priors)를 활용하여 어려운 장면에서의 SfM 견고함을 향상시킨 2025년 논문입니다.<br>
